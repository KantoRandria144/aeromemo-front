...
const NavigateBar = ({
  ...
  useEffect(() => {
    ...
    return (
        ...
        >
           ...
           <div className="flex items-center lg:justify-center justify-between gap-2 px-2 ">
  {/* --- Logo + Texte --- */}
  <div className="w-1/2 flex justify-center items-center space-x-2">
    ...
    {/* Logo ensuite */}
    <div className="rounded-lg flex items-center justify-center w-25 h-25">
      <div className="flex space-x-0.5">
        <img src={Logo} alt="Logo" className="w-full h-full object-contain" />
      </div>
    </div>

    <h1 className="text-xl font-semibold order-1">TailAdmin</h1>
  </div>
